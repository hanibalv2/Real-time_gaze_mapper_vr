...
public class Scatterplot : MonoBehaviour
{
    ...
    public void visualizeData(Vector3[] data)
    {
        ...
        for (int index = 0; index < data.Length; index++)
        {
            ...
            if (vertexCount + dataPointMeshFilter.mesh.vertexCount > 65000 || index == data.Length - 1)
            {
                ...
                //submesh.GetComponent<MeshCollider>().sharedMesh = CombinedMesh;
    ...
    {
        StreamReader myReader = new StreamReader(Application.dataPath + pathToFile);
